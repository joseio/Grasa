...
paramTable = t.find('table', id="tparamvaluesID0EU") # table containing parameter values
...
print "Pex Done Generating Tests"
if done == True:
	with open('../../../PreconditionTool/pre.data', 'a+') as myfile:
